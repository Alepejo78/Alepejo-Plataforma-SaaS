...
function RelatorioExamesPageInner() {
  ...
  const filtered = employees.filter((e) => {
    ...
    if (status && examStatus(e.nextExamDate) !== status) {
      return false;
    }
  ...
  function handleExport() {
    exportCsv(
      ...
      filtered.map((e) => [
        ...
        date(e.nextExamDate),
        EXAM_STATUS_LABELS[examStatus(e.nextExamDate)],
      ])
    );
  }
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            >
              ...
              {Object.entries(EXAM_STATUS_LABELS).map(
                ([value, label]) => (
            ...
            {loading ? (
              ...
              <tr>
                <td
                  ...
                  className="px-3 py-6 text-center text-[var(--text-muted)]"
                >
                  Nenhum colaborador encontrado com esses
                  filtros.
                </td>
              </tr>
            ) : (
              filtered.map((e) => {
                const st = examStatus(e.nextExamDate);
...
export default function RelatorioExamesPage() {
  return (
    <ReportAccessGuard permission="employee.report">
      <RelatorioExamesPageInner />
    </ReportAccessGuard>
  );
}
