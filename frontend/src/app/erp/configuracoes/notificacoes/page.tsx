 ...
 *
 * Cabeçalho/rodapé/template de PDF morava aqui — virou tela própria
 * em "Alteração de template" (decisão do usuário, 09-09-2026): não é
 * um assunto de WhatsApp, misturar os dois só confundia.
 */
