...
import { FileEdit, Trash2, Upload } from "lucide-react";
...
export default function AlteracaoTemplatePage() {
  ...
  return (
    <PageAccessGuard permission="email.manage">
      <OsShell workspaceLabel="Alteração de template">
        <div className="mx-auto max-w-5xl space-y-6 p-6">
          <div className="flex items-center gap-2">
            <FileEdit size={22} className="text-[var(--text-secondary)]" />
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
            ...
            <p className="mt-1 text-sm text-[var(--text-muted)]">
              Texto colado no topo e no fim de todo PDF gerado pelo
              sistema (orçamento, holerite, ordem de serviço) — aviso
              legal, dados adicionais da empresa etc. Deixe em branco
              pra não mostrar nada extra.
            </p>
