...
export default function VendasPage() {
  ...
  // e vale por cima disso ao salvar. Vindo de um Pedido de Venda, as
  // parcelas já foram herdadas prontas (possivelmente já com
  // acréscimo, se o pedido também aplicou o dele) — não soma de novo.
  const netTotalWithSurcharge =
    paymentSettings && !(sourceType === "salesOrder" && sourceId)
